...
> Install via `brew install --cask arvesolland/tap/ralph`.
...
- [x] `brew install --cask arvesolland/tap/ralph` installs latest version
- [x] Cask includes description and homepage
- [x] Test installation in clean environment

**Subtasks:**
1. [x] Configure brew section in goreleaser
2. [x] Set up homebrew tap repository
3. [x] Test formula generation
